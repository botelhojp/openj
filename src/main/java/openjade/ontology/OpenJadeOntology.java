...
public class OpenJadeOntology extends jade.content.onto.Ontology  {
  ...
  public static Ontology getInstance() {
   ...
   // VOCABULARY
    ...
    public static final String SENDITERATION_ITERATION="iteration";
    public static final String SENDITERATION="SendIteration";
  ...
  */
  private OpenJadeOntology(){ 
    ...
    AgentActionSchema sendIterationSchema = new AgentActionSchema(SENDITERATION);
    add(sendIterationSchema, openjade.ontology.SendIteration.class);
    ...
    sendIterationSchema.add(SENDITERATION_ITERATION, (TermSchema)getSchema(BasicOntology.INTEGER), ObjectSchema.MANDATORY);
    ...
    sendRatingSchema.add(SENDRATING_RATING, ratingSchema, ObjectSchema.MANDATORY);
