...
public class OpenJadeOntology extends jade.content.onto.Ontology  {
  ...
  */
  private OpenJadeOntology(){ 
    ...
    AgentActionSchema witnessSchema = new AgentActionSchema(WITNESS);
    add(witnessSchema, openjade.ontology.Witness.class);
    ...
    witnessRequestSchema.addSuperSchema(witnessSchema);
    witnessResponseSchema.addSuperSchema(witnessSchema);
